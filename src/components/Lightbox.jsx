...
export default function Lightbox({ lightbox, photos, onClose, onPrev, onNext }) {
  return (
    <div
      ...
      onClick={onClose}
    >
      <img src={lightbox} alt="" className="lb-img" style={{ maxWidth: '60vw', maxHeight: '60vh', objectFit: 'contain', borderRadius: '4px', display: 'block' }} onClick={e => e.stopPropagation()} />
